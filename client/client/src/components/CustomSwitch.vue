  ...
  <div class="switch">
    <div class="switch_box">
      <input
        ...
        :data-theOtherValue="theOtherValue"
        @click="checkStateChange($event)"
      />
...
export default {
  name: "DayMonthSwitch",
  props: ["defaultCheck", "defaultValue", "theOtherValue"],
  emits: ["checkStateChange"],
  methods: {
    ...
    checkStateChange: function (e) {
      this.$emit("checkStateChange", e);
    },
  },
};
</script>
...
.switch {
  ...
  &_checkbox:checked + &_text::before {
    content: attr(data-theOtherValue);
    // 利用left实现移动效果
    left: 48px;
